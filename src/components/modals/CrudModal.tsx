...
import { Table, CrudFunction, CrudData } from '../../types';
...
interface CrudModalProps {
    ...
    crudData: CrudData;
    addCrudFunction: () => void;
    updateCrudFunctionName: (funcId: string, name: string) => void;
    deleteCrudFunction: (funcId: string) => void;
    toggleCrudValue: (funcId: string, tableId: string, type: 'C' | 'R' | 'U' | 'D') => void;
}
                            ...
                            <table className="w-full text-left border-collapse min-w-max">
                                ...
                                <tbody>
                                    ...
                                    {crudFunctions.length === 0 && (
                                        <tr>
                                            <td colSpan={crudFunctions.length + 1} className="p-8 text-center text-gray-400 bg-gray-50 sticky left-0">
